...
import { StatsDocument } from "@shared/models/stats.model";
import { IStats, ITempObject } from "@/types/controllers/dashboard";

export const getShortendLinkStats = async (req: Request, res: Response) => {
  ...
  const link_stats = shortend_url_obj.stats as StatsDocument;
